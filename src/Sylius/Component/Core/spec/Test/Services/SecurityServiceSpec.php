...
class SecurityServiceSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldImplement('Sylius\Component\Core\Test\Services\SecurityServiceInterface');
    }
    ...
    function it_does_not_log_user_in_if_user_was_not_found(
        ...
        $this->shouldThrow(new EntityNotFoundException('There is no user with email sylius@example.com'))->during('logIn', array('sylius@example.com', 'default', $minkSession));
    }
}
