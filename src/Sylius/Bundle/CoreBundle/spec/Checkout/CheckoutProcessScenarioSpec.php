...
class CheckoutProcessScenarioSpec extends ObjectBehavior
{
    ...
    function it_builds_checkout_process_with_proper_steps(ProcessBuilderInterface $builder, $cart)
    {
        ...
        $builder->setRedirect('sylius_checkout_thank_you_page')->willReturn($builder)->shouldBeCalled();

        $cart->getId()->willReturn(1);
        $builder->setRedirectParams(array('id' => 1))->willReturn($builder)->shouldBeCalled();
